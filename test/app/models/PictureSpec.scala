...
class PictureSpec extends Specification {
  ...
  "The list of categories" should {
    "contain references from 2004 to 2013" in {
  ...
  "The list of sub-folders for 2004" should {
    "contain 2 galleries : misc and venise" in {
  ...
  "First picture of gallery 2004/0406_misc" should {
    ...
    "have a thumbnail short path equal to small_0406_Adrien.jpg" in {
  ...
  "First picture of gallery 2013/1312_1" should {
    val pictures = Picture.pictures("2013", "1312_1")
    val first = pictures.head

    "have a thumbnail short path equal to 201312_bdi_mumbai_002.jpg" in {
